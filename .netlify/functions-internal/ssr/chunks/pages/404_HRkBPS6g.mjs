...
import { l as lookup, i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_CIixJMLy.mjs';
import { A as AstroError, b as InvalidImageService, c as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, d as createAstro, e as createComponent, f as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, g as addAttribute, s as spreadAttributes, h as defineScriptVars, i as renderComponent, u as unescapeHTML, j as Fragment, k as renderHead, l as renderSlot } from '../astro_C6C2Eh3i.mjs';
import 'kleur/colors';
/* empty css                                  */
import fs from 'fs';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_CIixJMLy.mjs'
    ).then(n => n.s).catch((e) => {
...
const $$Astro$e = createAstro("https://secureathlete.net");
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/node_modules/astro/components/Image.astro", void 0);

const $$Astro$d = createAstro("https://secureathlete.net");
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/node_modules/astro/components/Picture.astro", void 0);

const imageConfig = {"service":{"entrypoint":"astro/assets/services/squoosh","config":{}},"domains":[],"remotePatterns":[]};
					new URL("file:///Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/dist/");
...
const $$Astro$c = createAstro("https://secureathlete.net");
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/src/components/common/CommonMeta.astro", void 0);

const favIcon = "/_astro/favicon.CGiRCjPI.ico";

const favIconSvg = new Proxy({"src":"/_astro/favicon.vp_fBu0c.svg","width":128,"height":128,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/src/assets/favicons/favicon.svg";
							}
...
const appleTouchIcon = new Proxy({"src":"/_astro/apple-touch-icon.DHIlG7dp.png","width":180,"height":180,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/src/assets/favicons/apple-touch-icon.png";
							}
...
const $$Astro$b = createAstro("https://secureathlete.net");
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/src/components/Favicons.astro", void 0);

const $$Astro$a = createAstro("https://secureathlete.net");
const $$CustomStyles = createComponent(async ($$result, $$props, $$slots) => {
  ...
  :root {
    --aw-font-sans: 'Public Sans';
    --aw-font-serif: var(--aw-font-sans);
    --aw-font-heading: var(--aw-font-sans);

    --aw-color-primary: rgb(171 132 68);
    --aw-color-secondary: rgb(231 191 117);
    --aw-color-accent: rgb(248 210 16);

    --aw-color-text-heading: rgb(0 0 0); 
    --aw-color-text-default: rgb(16 16 16);
    --aw-color-text-muted: rgb(16 16 16 / 66%);
    --aw-color-bg-page: rgb(245, 245, 245);
  ...
  .dark {
    ...
    --aw-color-text-heading: rgb(29 29 31); 
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/src/components/CustomStyles.astro", void 0);

var __freeze$2 = Object.freeze;
var __defProp$2 = Object.defineProperty;
var __template$2 = (cooked, raw) => __freeze$2(__defProp$2(cooked, "raw", { value: __freeze$2(raw || cooked.slice()) }));
var _a$2;
const $$Astro$9 = createAstro("https://secureathlete.net");
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/src/components/common/ApplyColorMode.astro", void 0);
...
const $$Astro$8 = createAstro("https://secureathlete.net");
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/node_modules/@astrolib/seo/src/AstroSeo.astro", void 0);

const load = async function() {
  let images = void 0;
  try {
    images = /* #__PURE__ */ Object.assign({"/src/assets/images/app-store.png": () => import('./mobile-app_CGEYHdjV.mjs').then(n => n.b),"/src/assets/images/default.png": () => import('../default_CpaS3K1m.mjs'),"/src/assets/images/google-play.png": () => import('./mobile-app_CGEYHdjV.mjs').then(n => n.g),"/src/assets/images/hero.png": () => import('../hero_BYf-WERO.mjs')});
  } catch (e) {
  }
  return images;
};
...
const $$Astro$7 = createAstro("https://secureathlete.net");
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/src/components/common/Metadata.astro", void 0);

const $$Astro$6 = createAstro("https://secureathlete.net");
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/src/components/common/SiteVerification.astro", void 0);
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/node_modules/@astrolib/analytics/src/GoogleAnalytics.astro", void 0);
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/src/components/common/Analytics.astro", void 0);
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/src/components/common/BasicScripts.astro", void 0);
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/node_modules/astro/components/ViewTransitions.astro", void 0);
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/src/layouts/BaseLayout.astro", void 0);
...
const $$404 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$BaseLayout, { "metadata": { title } }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="flex items-center h-full p-16"> <div class="container flex flex-col items-center justify-center px-5 mx-auto my-8"> <div class="max-w-md text-center"> <h2 class="mb-8 font-bold text-9xl"> <span class="sr-only">Error</span> <span class="text-primary">404</span> </h2> <p class="text-3xl font-semibold md:text-3xl">Sorry, we couldn't find this page.</p> <p class="mt-4 mb-8 text-lg text-muted dark:text-slate-400">
...
}, "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/src/pages/404.astro", void 0);

const $$file = "/Users/keithrobinson/Personal_Repos/POC_Secure_Athlete/src/pages/404.astro";
const $$url = "/404";
...
export { $$BaseLayout as $, APP_BLOG as A, BLOG_BASE as B, CATEGORY_BASE as C, I18N as I, METADATA as M, POST_PERMALINK_PATTERN as P, SITE as S, TAG_BASE as T, UI as U, _404 as _, getHomePermalink as a, getAsset as b, getPermalink as c, getBlogPermalink as d, getConfiguredImageService as e, findImage as f, getImage as g, cleanSlug as h, imageConfig as i, getFormattedDate as j, getCanonical as k, $$Image as l, trimSlash as t };
